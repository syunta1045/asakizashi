 ...
 * 四柱推命（Bazi）計算エンジン
 *
 * 朝しるべでは時柱を使わず、年柱・月柱・日柱の3柱のみ算出する。
...
export const stemKana: Record<Stem, string> = {
  甲: "きのえ", 乙: "きのと", 丙: "ひのえ", 丁: "ひのと", 戊: "つちのえ",
  己: "つちのと", 庚: "かのえ", 辛: "かのと", 壬: "みずのえ", 癸: "みずのと",
};
export const branchKana: Record<Branch, string> = {
...
export const stemMeaning: Record<Stem, string> = {
  甲: "大樹のように真っ直ぐ伸びるタイプ。リーダー性",
  乙: "草花のようにしなやかで、人に寄り添う優しさ",
  丙: "太陽のような明るさと情熱。場を明るくする",
...
export const branchMeaning: Record<Branch, string> = {
  子: "種から芽吹く始まりのタイプ。知性と機転",
  丑: "粘り強く積み重ねるタイプ。誠実と忍耐",
  寅: "勢いよく踏み出すタイプ。情熱と勇気",
  卯: "やわらかに広がるタイプ。穏やかさと社交",
  辰: "大きな理想を持つタイプ。広い視野",
  巳: "物事を見抜くタイプ。直観と洞察",
  午: "明るく表現するタイプ。陽気と表現力",
  未: "実りを大切にするタイプ。優しさと家庭性",
  申: "機転がきくタイプ。器用さと変化への適応",
  酉: "整えることが得意なタイプ。美意識と几帳面さ",
  戌: "守ることを大切にするタイプ。忠実と責任感",
  亥: "内側に力を蓄えるタイプ。芯の強さと無垢",
};
...
export function pillarKana(p: Pillar): string {
  return `${stemKana[p.stem]}・${branchKana[p.branch]}`;
}
