...
## [1.0.3] - 2026-07-04 — 品質改善アップデート（1.0.2承認後）

### 直したところ
- 朝メモの「連続記録」が朝の時間帯にリセット表示される不具合を修正
- 生年月日を後から入力できるようにし、機種変更時に情報が消えないよう改善
- 朝の内容が時刻によって前日にずれる不具合を修正
- 「今日の大切な人」を生年月日なしでも表示

### 追加・改善
- **見返し**: 気分の波を直近7日／プレミアムで30日・90日でふり返れる画面を新設
- 続けた記録が途切れても「おかえり」で再開しやすく
- オフライン時にプレミアムが一時的に解除される問題を改善
- ペイウォールの表記・価格表示を正確に、購入の計測を整備
- 画面まわりの導線・コピー・アクセシビリティを調整

### 品質
- TypeScript 0 errors / ESLint 0 warnings / テスト 167件 全合格
